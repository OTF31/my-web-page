...
class MenuLateral extends React.Component {
  ...
  render() {
    ...
    return (
      <>
        {
          <div className={`fixed top-0 left-0 sm:w-12 md:lg:w-[17%] h-screen rounded-r-lg bg-primary-color text-xs md:text-[16px] lg:text-xl`} >
            ...
            <div className="flex flex-col w-full h-full gap-1 mt-7">
              <img className="self-center w-8 h-8 mt-12 mb-4 md:lg:mt-2 md:lg:w-16 md:lg:h-16 rounded-3xl" src="https://w7.pngwing.com/pngs/825/857/png-transparent-computer-icons-user-profile-user-silhouette-apple-icon-image-format-user-profile.png" alt="" />
              <h3 className="self-center text-white font-[Montserrat] hidden text-[14px] md:lg:text-[24px] md:lg:block text-center">{this.props.datosPerfil["nombres"]}</h3>
              <h3 className="self-center mb-6 text-white font-[Montserrat] hidden text-[14px] md:lg:text-[24px] md:lg:block text-center">{this.props.datosPerfil["apellidos"]}</h3>
              ...
              <button className="flex justify-between items-center self-stretch p-2 ml-1 mr-1 text-white shadow-inner shadow-orange-500 hover:bg-secondary-color hover:text-black font-[Montserrat]">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 lg:w-8 lg:h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <button className="absolute left-2 bottom-3">
                <svg xmlns="http://www.w3.org/2000/svg" className="z-10 self-start w-6 h-6 text-white rounded-md" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
