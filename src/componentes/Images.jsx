...
class Images extends React.Component {
  render() {
    return (
      <>
        <div className="py-8 mt-12 mb-4 mr-4 rounded-md bg-stone-800 px-30">
          <h1 className="mx-10 text-2xl font-bold text-center text-white font-[Montserrat]">
            Imágenes
          </h1>
          ...
          <button className="flex border-2 mx-auto px-4 py-2 font-bold -mb-6 bg-blue-600 rounded text-white hover:bg-blue-800 font-[Montserrat]">
            Ver más ...
          </button>
        </div>
      </>
